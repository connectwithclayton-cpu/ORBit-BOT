...
AUDIT_PY="${BOT_DIR}/scripts/audit_moomoo_sync.py"
LOG_JSONL="${BOT_DIR}/audit_sync.jsonl"
STATE_JSON="${BOT_DIR}/audit_sync_state.json"
LOCK_DIR="${BOT_DIR}/.audit_sync.lock"
