...
Output files:
  ~/Documents/TRADING/Fabio_bot/trade_data.json       ← persistent data store
  ~/Documents/TRADING/Fabio_bot/live_dashboard.html
  ~/Documents/TRADING/fabio_live_dashboard.html        ← easy-access copy
"""
...
DATA_FILE   = os.path.join(_DIR, "trade_data.json")
DASH_LOCAL  = os.path.join(_DIR, "live_dashboard.html")
