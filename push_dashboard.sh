...
# Can also be run manually: bash ~/Documents/TRADING/Fabio_bot/push_dashboard.sh

BOT_DIR="$HOME/Documents/TRADING/Fabio_bot"
LIVE_SRC="$HOME/Documents/TRADING/fabio_live_dashboard.html"
BACKTEST_SRC="$HOME/Documents/TRADING/orb_vs_fabio_dashboard.html"
REPO_DIR="$HOME/Documents/TRADING/orb-live-dashboard"
LOG="$BOT_DIR/dashboard_push.log"
